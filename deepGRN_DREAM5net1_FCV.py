...
from Demo import three_utils_2_single, dggan_embedding_param
from Demo import corrresnet_pred_128 as corrresnet_pred
...
path_expression = 'traindataDREAM5\\net1_expression_data.csv'

path_network_ids = 'traindataDREAM5\\DREAM5_Network_GRN_3types_ids.tsv'
path_node = 'traindataDREAM5\\net1_node.txt'
...
# read known regulation : TF,target gene, types(activator, repressor, unknown)
...
# get node bidirectional representation
GRN_embedding_s, GRN_embedding_t = dggan_embedding_param.dggan(path_network_ids, path_node)
# np.savetxt('GRN_embedding_s.csv', GRN_embedding_s, delimiter = ',')
# np.savetxt('GRN_embedding_t.csv', GRN_embedding_t, delimiter = ',')
